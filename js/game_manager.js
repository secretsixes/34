...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.99999999819819819819819819 ? Math.random() < 0.99999999 ? Math.random() < 0.99999998809523809523809523 ? Math.random() < 0.9999999879518072289156626 ? Math.random() < 0.9999999878048780487804878 ? Math.random() < 0.9999999876543209876543209 ? Math.random() < 0.99999998333333333333333333 ? Math.random() < 0.99999998 ? Math.random() < 0.9999999767441860465116279 ? Math.random() < 0.999999975 ? Math.random() < 0.9999999666666666666666666 ? Math.random() < 0.99999996428571428571428571 ? Math.random() < 0.9999999615384615384615384 ? Math.random() < 0.99999996 ? Math.random() < 0.999999958333333333333333333 ? Math.random() < 0.99999995 ? Math.random() < 0.9999999333333333333333333 ? Math.random() < 0.99999991666666666666666666 ? Math.random() < 0.9999999 ? Math.random() < 0.9999998333333333333333333 ? Math.random() < 0.9999998 ? Math.random() < 0.99999975 ? Math.random() < 0.999999666666666666666666 ? Math.random() < 0.9999995 ? Math.random() < 0.999999 ? Math.random() < 0.99999875 ? Math.random() < 0.999998 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.9999875 ? Math.random() < 0.99998 ? Math.random() < 0.9999705882352941176470 ? Math.random() < 0.9999375 ? Math.random() < 0.9998 ? Math.random() < 0.998 ? Math.random() < 0.99 ? Math.random() < 0.98 ? Math.random() < 0.9375 ? 1 : 3 : 5 : 7 : 17 : 33 : Math.random() < 0.5 ? Math.random() < 0.5 ? Math.random() < 0.5 ? 47 : 49 : Math.random() < 0.5 ? 50 : 51 : Math.random() < 0.5 ? Math.random() < 0.5 ? 54 : 70 : Math.random() < 0.5 ? 76 : 92 : Math.random() < 0.999 ? -34 : 34 : 9 : 68 : 170 : 340 : 35 : 680 : -1 : -2 : -3 : -4 : -5 : -6 : 0 : 60 : 78 : 48 : 81 : 82 : 83 : 84 : 22 : 53 : 43 : 96 : 27 : 8181 : 8282 : 8383 : 8484 : -7 : 55;
