...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.99999999 ? Math.random() < 0.99999996428571428571428571 ? Math.random() < 0.9999999615384615384615384 ? Math.random() < 0.99999996 ? Math.random() < 0.999999958333333333333333333 ? Math.random() < 0.9999999 ? Math.random() < 0.9999998333333333333333333 ? Math.random() < 0.9999998 ? Math.random() < 0.99999975 ? Math.random() < 0.999999666666666666666666 ? Math.random() < 0.9999995 ? Math.random() < 0.999999 ? Math.random() < 0.999995 ? Math.random() < 0.99999 ? Math.random() < 0.9999875 ? Math.random() < 0.9999705882352941176470 ? Math.random() < 0.9999375 ? Math.random() < 0.9998 ? Math.random() < 0.998 ? Math.random() < 0.99 ? Math.random() < 0.98 ? Math.random() < 0.9375 ? 1 : 3 : 5 : 7 : 17 : 33 : Math.random() < 0.5 ? Math.random() < 0.5 ? Math.random() < 0.5 ? 47 : 49 : Math.random() < 0.5 ? 50 : 51 : Math.random() < 0.5 ? Math.random() < 0.5 ? 54 : 70 : Math.random() < 0.5 ? 76 : 92 : Math.random() < 0.999 ? -34 : 34 : 68 : 170 : 340 : -1 : -2 : -3 : -4 : -5 : -6 : 0 : 81 : 82 : 83 : 84 : -7;
